...
async function handleClick(event) {
  ...
  try {
    ...
    if(action==='review-knowledge'){await api(`/api/admin/knowledge/${target.dataset.id}/review`,{method:'POST',body:{decision:target.dataset.decision,reusable_across_prospects:false}});toast('Knowledge review recorded.','success');renderAdmin('knowledge');return;}
