...
function speakAiText() {
  const text = document.getElementById('ai-enhanced-output')?.dataset.enhancedText || document.getElementById('ai-solution-output')?.dataset.enhancedText || document.getElementById('ai-benefits-output')?.dataset.enhancedText || document.getElementById('ai-demo-plan-output')?.dataset.enhancedText || document.getElementById('ai-enhanced-text')?.value || document.getElementById('ai-solution-text')?.value || '';
  if (!text) return;
